...
if [ -z "$1" ] || [ -z "$2" ]; then
    echo "Errore: parametri mancanti. Uso: ./porto4.sh [nave] [file_log]"
    exit 1
fi
...
read -p "Nome operatore: " operatore
